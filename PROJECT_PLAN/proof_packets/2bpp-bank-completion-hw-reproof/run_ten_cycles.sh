...
for cycle in $(seq 1 10); do
    ...
    loader_log="$packet/hardware/cycle_${tag}_openfpgaloader.log"
    serial_log="$packet/firmware/cycle_${tag}_serial.log"
    capture="$packet/captures/cycle_${tag}_720x480.yuyv"

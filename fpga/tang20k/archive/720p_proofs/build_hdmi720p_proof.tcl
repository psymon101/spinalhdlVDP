...
set TOP "top_tang20k_720p_proof"

set script_dir [file dirname [file normalize [info script]]]
cd $script_dir

# SpinalHDL-generated proof top (Hdmi720pProofTopVerilog).
add_file ../../hw/gen/top_tang20k_720p_proof.v
...
# No SDRAM in this proof — sdram_pll / nand2mario controller intentionally absent.

add_file tang20k_hdmi720p_proof.cst
add_file tang20k_hdmi720p_proof.sdc

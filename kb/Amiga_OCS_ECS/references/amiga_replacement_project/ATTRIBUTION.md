# Amiga Replacement Project — Attribution

**Source:** https://github.com/BuffeeProject/amiga_replacement_project  
**Author:** The Buffee Project  
**License:** CC BY-NC-SA 4.0 (Attribution-NonCommercial-ShareAlike 4.0 International)

**Files included:**
- `denise.v` — Amiga Denise (video chip) replacement in Verilog (764 lines)
